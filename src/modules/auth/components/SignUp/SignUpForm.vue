...
import type { SignUpSchema } from './constants/singUpSchema'

import { signUpSchema } from './constants/singUpSchema'
...
<template>
  ...
  <form class="card bg-base-100 flex flex-col py-3 w-full lg:w-1/4" @submit.prevent="onSubmit">
    ...
    <div class="pb-6 relative">
      <label class="flex items-center gap-2">
        ...
        <select
          class="select select-bordered w-full pl-12"
          v-bind="genderAttrs"
  ...
  <div>
    ...
    <a href="/auth?type=sign-in" class="underline text-blue-600">войти</a>
  </div>
</template>
