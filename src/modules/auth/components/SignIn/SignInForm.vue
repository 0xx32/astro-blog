...
<template>
	<div class='text-2xl font-bold mb-4'>Вход</div>
	<form @submit.prevent='onSubmit' class='card bg-base-100 flex flex-col py-3 w-full lg:w-1/4'>
		...
		<div class='flex gap-4 flex-col'>
			<button class='btn btn-primary' type='submit' :disabled='authIsPending'>Войти</button>
	...
	<div >Если у вас нет аккаунта, то <a href='/auth?type=sign-up'
			class='underline text-blue-600'>зарегистрироваться</a></div>
